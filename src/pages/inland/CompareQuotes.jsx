...
function CardSkeleton() {
  return (
    <div className="rounded-2xl px-5 py-6 flex flex-col items-center gap-3" style={{ background: '#FAFAFB', border: '1px solid #F3F4F6' }}>
...
function OutcomeCard({ outcome, submission, selected, onSelect }) {
  ...
  return (
    <div
      ...
      style={{
        background: isQuoted ? 'white' : '#FAFAFB',
        border: `1.5px solid ${selected ? '#5C2ED4' : isQuoted ? '#E5E7EB' : '#F3F4F6'}`,
